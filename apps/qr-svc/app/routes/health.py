"""
Маршруты для проверки здоровья Qr Svc сервиса.
...
health_router = create_health_router("qr-svc", "1.0.0")

# Добавляем проверки зависимостей
database_url = os.getenv("DATABASE_URL", "postgresql+asyncpg://storyqr:storyqr@postgres:5432/storyqr_qr")
