"""
Маршруты для проверки здоровья Auth сервиса.
...
health_router = create_health_router("auth-svc", "1.0.0")

# Добавляем проверки зависимостей
database_url = os.getenv("DATABASE_URL", "postgresql+asyncpg://storyqr:storyqr@postgres:5432/storyqr_auth")
...
async def health_check() -> HealthResponse:
    """
    Проверка здоровья Auth сервиса (legacy endpoint).
