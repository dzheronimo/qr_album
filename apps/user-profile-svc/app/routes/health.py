"""
Маршруты для проверки здоровья User Profile Svc сервиса.
...
health_router = create_health_router("user-profile-svc", "1.0.0")

# Добавляем проверки зависимостей
database_url = os.getenv("DATABASE_URL", "postgresql+asyncpg://storyqr:storyqr@postgres:5432/storyqr_user_profile")
